...
-- ----------------------------
--  Table structure for `usermahasiswas`
-- ----------------------------
DROP TABLE IF EXISTS `usermahasiswas`;
CREATE TABLE `usermahasiswas` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
-- ----------------------------
--  Table structure for `users_dosen`
-- ----------------------------
DROP TABLE IF EXISTS `users_dosen`;
...
-- ----------------------------
--  Table structure for `users_mahasiswa`
-- ----------------------------
DROP TABLE IF EXISTS `users_mahasiswa`;
CREATE TABLE `users_mahasiswa` (
  ...
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `users_mahasiswa_nim_unique` (`nim`),
  UNIQUE KEY `users_mahasiswa_email_unique` (`email`)
...
INSERT INTO `krs` VALUES ('1','1100000001','PK105','2016-07-27 10:51:12',NULL),  ('2','1100000001','PK102','2016-07-27 15:09:29',NULL),  ('3','1100000001','PK106','2016-07-28 15:01:45',NULL),  ('4','1100000001','PK204','2016-07-28 15:01:46',NULL);
INSERT INTO `mahasiswa` VALUES ('1100000001','Jokowi','Medan','2016-07-27','Medan','Sutisna'),  ('1100000002','Muhammad Basri','Medan','1995-12-20','sultan iskandar muda','IT profesional');
...
INSERT INTO `migrations` VALUES ('2014_10_12_000000_create_users_table','1'),  ('2014_10_12_100000_create_password_resets_table','1'),  ('2016_07_29_175124_create_users_mahasiswa_table','2'),  ('2016_07_29_175436_create_users_dosen_table','2'),  ('2016_08_01_123557_create_table_usermahasiswa','3'),  ('2016_08_01_123620_create_table_admins','3');
...
INSERT INTO `users` VALUES ('1','basri','muhammadbasri444@gmail.com','$2y$10$FJMZkrHVUlVammIA.hvgDeGf7OKxs1tHspY5/jS7WDI4mTjSpxLWS','YxbZ4S7jwkJOT3n0WRQS9NuqkunIJg0JpcmqMoCflis4TnUplPkTtBo66IAG','2016-07-29 08:30:58','2016-08-01 11:17:30','1');
INSERT INTO `users_dosen` VALUES ('1','1001','Muhammad Basri','muhammadbasri61@gmail.com','$2y$10$ijEi6jsKcZALN9Kob.v4MeQvNM9Sk9qSG1lIAg1TMlWpdIMXMAthO',NULL,'2016-08-01 04:36:19','2016-08-01 04:36:19'),  ('2','1002','test','basri@gmail.com','$2y$10$meaUfSI18F7e/l1vhd4zs.z6JKtzsR1MY6qbm8UMYK49PDvhj78t.',NULL,'2016-08-01 04:37:32','2016-08-01 04:37:32');
INSERT INTO `users_mahasiswa` VALUES ('3','1100000001','Jokowi','jokowi@gmail.com','$2y$10$fiDEsgVW/557GQ42bwWSWOfTo//erQR6r7nquBM0n1fQCCgLWVuw.',NULL,'2016-08-01 09:49:00','2016-08-01 09:49:00');
