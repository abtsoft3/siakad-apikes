					...
					<div class="col-lg-6 col-sm-6 col-xs-5">
						{!! Form::open(array('url' => '/updateperiode','class'=>'form-horizontal','id'=>'form-periode','autocomplete'=>'off')) !!}
							...
							<div class="form-group">
								...
								<div class="col-sm-7">
									{!! Form::text('sistem',$periode->sistem,array('class' => 'form-control')) !!}
								</div>
							</div>
								...
								<div class="col-sm-5">
									 <div class="input-group dtpicker">
										<div class="input-group-addon"><i class="fa fa-calendar"></i></div>
											{!! Form::text('tglawal',$periode->tglawal,array('class' => 'form-control')) !!}
								...
								<div class="col-sm-5">
									 <div class="input-group dtpicker">
										<div class="input-group-addon"><i class="fa fa-calendar"></i></div>
											{!! Form::text('tglakhir',$periode->tglakhir,array('class' => 'form-control')) !!}
		...
		$('#form-periode').bootstrapValidator({
				...
				fields: {
					...
					idperiode: {
						validators: {
							notEmpty: {
								message: 'Silahkan isi id periode'
							}
